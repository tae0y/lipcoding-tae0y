...
The bundled example images in `examples/images/` and `flat-black-and-white-illustrations/assets/examples/` were generated by Ian and are included as style calibration examples for this skill.
